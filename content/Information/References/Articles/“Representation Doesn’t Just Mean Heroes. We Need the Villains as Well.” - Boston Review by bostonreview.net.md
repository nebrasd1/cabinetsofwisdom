...
## Highlights
### None
> You’ve mentioned that unreliable narrators are characteristic of African storytelling and myth.

✏️ this is great.. I should use arabic storytelling characteristics as a way to tell new stories (such as the framing device etc.) but turn that into multiple stories overlapping each other somehow (without it turning into cloud atlas)
